# AutoSubs Pipeline (Documento de Arquitectura y Requisitos)
...
- **Limites de Lectura (CPS/CPL):** Control estricto de la longitud de la traducción para garantizar tiempos de lectura cómodos directamente desde el LLM.
